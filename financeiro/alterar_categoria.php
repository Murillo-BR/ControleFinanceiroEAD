        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <form action="alterar_categoria.php" method="POST">
                    <input type="hidden" name="cod" value="<?= $dados[0]['id_categoria'] ?>"></input>
                    ...
                    <button type="submit" class="btn btn-success" name="btnSalvar" onclick="return AlterarCategoria();">Salvar</button>
