...
class CategoriaDAO extends Conexao{
    public function CadastrarCategoria($nomeCategoria){
        if ($nomeCategoria == '') {
            ...
            // 2º Passo: Vamos criar o ScriptSQL que será executado no Banco de Dados pelo PDO!
            ...
            //5º Passo: Vamos identificar e validar o que está sendo passado para o Banco de Dados!
    ...
    public function ConsultarCategoria(){
        ...
        // Realiza a consulta do Banco de Dados via PDO, monta e retorna um Array com tudo que foi encontrado!
